...
# If you do not change the name of the vulnerability_mgmt docker container
# then using the name(postgres) as Host works
POSTGRESQL_HOST = os.environ.get('POSTGRES_HOST', 'postgres')
# default port for postgresql is 5432 and therefore is the default value here
POSTGRESQL_PORT = os.environ.get('POSTGRES_PORT', '5432')
# If no name is provided postgres uses the user name as name
# The name for the default database is set in docker compose file and
# is 'default'
